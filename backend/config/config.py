...
DIR_PATH = os.path.dirname(os.path.abspath(__file__)) # MMAPIS/backend/config
MMAPIS_PATH = os.path.dirname(DIR_PATH) # MMAPIS/backend
...
NOUGAT_CONFIG["check_point"] = os.path.join(MMAPIS_PATH, NOUGAT_CONFIG["check_point"])
